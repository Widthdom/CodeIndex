...
`CDIDX_HOOK_DISCOVERY_MAX_DLLS` 件（既定 128）までの DLL 候補を調べ、その bounded candidate set を
path order で load します。public parameterless constructor を持つ concrete hook type が instantiate されます。
