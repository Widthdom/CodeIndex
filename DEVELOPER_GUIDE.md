...
- The advertised capability surface includes `tools`, `resources`, and
  ...
  `resource_chunk_coverage_incomplete`, `chunk_limit_exceeded`, and
  `scan_limit_exceeded`.
