...
internal static class CliFlagSchema
{
    ...
    private static IReadOnlyList<CliFlag> BuildAll()
    {
        return new List<CliFlag>
        {
            ...
            new() { Name = "--origin-passes", ValuePlaceholder = "<n>", Description = "Search/Audit/Find --regex: C# lexical passes per file (1-16; default 1), each bounded at 4096 lines, 8 Mi characters and 128 chunks; restart without cursor to change", PrimaryCommands = Set("search", "audit", "find") },
