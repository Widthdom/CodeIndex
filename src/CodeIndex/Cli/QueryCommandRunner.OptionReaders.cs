...
public static partial class QueryCommandRunner
{
    ...
    private static readonly Dictionary<string, string> MissingOptionValueHints = new(StringComparer.Ordinal)
    {
        ...
        ["--cursor"] = "pass the `next_cursor` returned by a prior paged response, such as `response:v1:<offset>:<fingerprint>`, a recipe search cursor, `outline:<offset>`, or `unused:<offset>`.",
