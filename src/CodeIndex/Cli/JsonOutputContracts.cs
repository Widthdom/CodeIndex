...
internal sealed record DiffJsonResult(
    ...
    [property: JsonPropertyName("references_only_in_left")] List<string>? ReferencesOnlyInLeft,
    [property: JsonPropertyName("references_only_in_right")] List<string>? ReferencesOnlyInRight,
    [property: JsonPropertyName("chunks_only_in_left")] List<string>? ChunksOnlyInLeft,
    [property: JsonPropertyName("chunks_only_in_right")] List<string>? ChunksOnlyInRight,
...
internal sealed class IndexUpdateJsonResult : IVersionedJsonResult
{
    ...
    public SizeOmissionSummary? SizeOmissions { get; init; }
...
[JsonSerializable(typeof(HookExecutableJsonResult))]
[JsonSerializable(typeof(HookCommandFileChangeJsonResult))]
[JsonSerializable(typeof(List<HookCommandFileChangeJsonResult>))]
...
[JsonSerializable(typeof(SearchAuditClassificationJsonResult))]
[JsonSerializable(typeof(List<SearchAuditClassificationJsonResult>))]
...
[JsonSerializable(typeof(SearchRecipeCompactListItemJsonResult))]
[JsonSerializable(typeof(SearchRecipeCompactListJsonResult))]
...
[JsonSerializable(typeof(SearchRecipeClassifierCountJsonResult))]
[JsonSerializable(typeof(SearchRecipeClassifierCategoryCountJsonResult))]
...
[JsonSerializable(typeof(SearchRecipeQueryFreshnessStateJsonResult))]
...
[JsonSerializable(typeof(SearchRecipeCountRunJsonResult))]
[JsonSerializable(typeof(SearchRecipeCountSummaryRunJsonResult))]
[JsonSerializable(typeof(SearchRecipeCountSummaryQueryJsonResult))]
[JsonSerializable(typeof(SearchRecipeCountQueryJsonResult))]
[JsonSerializable(typeof(SearchRecipeAggregationRunJsonResult))]
[JsonSerializable(typeof(SearchRecipeAggregationQueryJsonResult))]
[JsonSerializable(typeof(SearchRecipeTopFileJsonResult))]
[JsonSerializable(typeof(SearchRecipeQueryListItemJsonResult))]
[JsonSerializable(typeof(SearchRecipeGuardFilterJsonResult))]
...
[JsonSerializable(typeof(SearchRecipeCoverageJsonResult))]
[JsonSerializable(typeof(SearchRecipeCoverageSetJsonResult))]
[JsonSerializable(typeof(SearchRecipeUnexecutedScopeJsonResult))]
[JsonSerializable(typeof(SearchRecipeHumanReviewJsonResult))]
