...
public static partial class ConsoleUi
{
    ...
    [
        ...
        ("audit", "cdidx audit (<recipe|recipe/query>|--all) [search filters] [--json[=ndjson]] [--format <text|json|count|compact|issue-drafts>] [--summary-only] [--limit <n>] [--total-limit <n>] [--allow-partial] [--results-only] [--search-fields <csv>] [--first-per-file] [--sample <n>] [--max-json-bytes <n>] [--snippet-lines <n>]"),
