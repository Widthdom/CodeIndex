...
public static partial class ConsoleUi
{
    ...
    [
        ...
        ("deps", "cdidx deps [--db <path>] [--json] [--format <dot|graphml|json-graph|edgelist>] [--summary-only] [--max-json-bytes <n>] [--verbose] [--limit <n>|--top <n>] [--cursor <cursor>] [--graph-budget <n>] [--lang <lang>] [--path <glob>] [--exclude-path <glob>] [--exclude-tests] [--reverse] [--cycles] [--group-partial-types] [--suppress-noise] [--resolution-state <state[,state]>] [--reference-kind <kind[,kind]>] [--symbol <name>] [--symbol-family <prefix>]"),
