...
public static class ConsoleUi
{
    ...
    private static void PrintFlagReference(Action<string> WriteHelpLine)
    {
        ...
        WriteHelpLine("  --group-by <unit>          search: with --count, group rows by file, symbol, origin, or return-type; hotspots: group by symbol or file, or by statement only with --lang sql");
