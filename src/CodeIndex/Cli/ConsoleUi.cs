...
public static partial class ConsoleUi
{
    ...
    [
        ...
        ("audit-baseline-export", "cdidx audit baseline-export <baseline.json> [--recipe <name>] [--db <path>] [--lang <lang>] [--path <glob>] [--exclude-path <glob>] [--exclude-tests] [--audit-scope <source|all>] [--since <datetime>] [--limit <n>] [--total-limit <n>] [--overwrite] [--json]"),
        ("audit-baseline-compare", "cdidx audit baseline-compare <baseline.json> [--recipe <name>] [--db <path>] [--lang <lang>] [--path <glob>] [--exclude-path <glob>] [--exclude-tests] [--audit-scope <source|all>] [--since <datetime>] [--limit <n>] [--total-limit <n>] [--json]"),
        ("audit-baseline-review", "cdidx audit baseline-review <baseline.json> <id> --actor <actor> --reason <reason> --overwrite [--json]"),
        ("audit", "cdidx audit (<recipe|recipe/query>|--all) [search filters] [--json[=ndjson]] [--format <text|json|count|compact|issue-drafts>] [--summary-only] [--limit <n>] [--total-limit <n>] [--progress (all only)] [--no-progress] [--quiet] [--allow-partial] [--results-only] [--search-fields <csv>] [--first-per-file] [--sample <n>] [--max-json-bytes <n>] [--snippet-lines <n>]"),
