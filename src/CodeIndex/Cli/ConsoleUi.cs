...
public static class ConsoleUi
{
    ...
    [
        ...
        ("find", "cdidx find <query> (--path <glob>|--all) [--db <path>] [--json] [--format <text|json|count|compact|csv|tsv|lsp|qf|sarif>] [--verbose] [--limit <n>|--top <n>] [--lang <lang>] [--exclude-path <glob>] [--exclude-tests] [--before <n>] [--after <n>] [--snippet-lines <n>] [--focus-line <line>] [--focus-column <n>] [--max-line-width <n>] [--line-scan-limit <n>] [--exact] [--regex] [--count]"),
        ...
        ("impact", "cdidx impact <query>|--query <query>|-- <query> [--db <path>] [--json] [--max-json-bytes <n>] [--verbose] [--limit <n>|--top <n>] [--lang <lang>] [--path <glob>] [--exclude-path <glob>] [--exclude-tests] [--body] [--snippet-lines <n>] [--max-line-width <n>] [--max-hops <n>] [--exact-name] [--count] [--with-paths]"),
    ...
    [
        ...
        ("symbols", "With --max-json-bytes, JSON output truncates result rows and reports omission metadata."),
        ("search", "With --max-json-bytes, --json=ndjson truncates at a row boundary and reports interruption metadata; --json=array rejects the whole output when it does not fit."),
