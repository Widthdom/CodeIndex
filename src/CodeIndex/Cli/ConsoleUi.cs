...
public static class ConsoleUi
{
    ...
    [
        ...
        ("audit", "cdidx audit <recipe|recipe/query> [search filters] [--json[=ndjson]] [--format <text|json|count|compact|issue-drafts>] [--limit <n>] [--total-limit <n>] [--results-only] [--search-fields <csv>] [--per-file-limit <n>] [--max-json-bytes <n>] [--snippet-lines <n>]"),
    ...
    [
        ...
        ("audit", "Alias for `cdidx search --recipe <recipe>`; low-output flags include --results-only, --search-fields, --per-file-limit, --total-limit, --max-json-bytes, and --snippet-lines 0 with issue-drafts."),
