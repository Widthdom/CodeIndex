...
internal static class EnvironmentVariableInventory
{
    ...
    [
        ...
        Item(IndexCommandRunner.IndexParallelismEnvironmentVariable, "indexing", SensitivityPublic, "performance", "CPU count capped at 8", "no", "Full-scan and authoritative C# update extraction worker count; explicit values are capped at 16.", Location("src/CodeIndex/Cli/IndexCommandRunner.Parse.cs", 25, "IndexCommandRunner")),
