...
public static partial class IndexCommandRunner
{
    ...
    private sealed class UpdatePrecomputedFilePersistenceContext
    {
        internal required DbWriter Writer { get; init; }
        internal required IndexCommandOptions Options { get; init; }
        internal required UpdateParallelExtractionResult Item { get; init; }
    ...
    private static UpdateFilePersistenceResult PersistPrecomputedUpdateFile(
        UpdatePrecomputedFilePersistenceContext context)
    {
