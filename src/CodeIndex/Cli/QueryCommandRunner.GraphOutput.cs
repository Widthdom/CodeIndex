...
public static partial class QueryCommandRunner
{
    ...
    private static readonly string[] AllValidReferenceKinds =
        ["annotation", "attribute", "augmentation", "bcl_regex_without_timeout", "binding", "call", "capture", "consumes_hook", "dependency", "friend", "generic_type_argument", "import", "instantiate", "member_read", "project_reference", "razor_event_binding", "resource_reference", "subscribe", "type_reference", "type_tag", "unsubscribe"];
    ...
    private static readonly string[] CallGraphOnlyReferenceKinds =
        ["augmentation", "call", "capture", "consumes_hook", "friend", "generic_type_argument", "instantiate", "member_read", "project_reference", "razor_event_binding", "subscribe", "unsubscribe"];
