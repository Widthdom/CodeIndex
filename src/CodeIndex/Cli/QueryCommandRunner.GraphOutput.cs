...
public static partial class QueryCommandRunner
{
    ...
    private static readonly string[] AllValidReferenceKinds =
        ["annotation", "attribute", "augmentation", "bcl_regex_without_timeout", "call", "consumes_hook", "dependency", "friend", "generic_type_argument", "import", "instantiate", "razor_event_binding", "subscribe", "type_reference", "type_tag", "unsubscribe"];
    ...
    private static readonly string[] CallGraphOnlyReferenceKinds =
        ["augmentation", "call", "consumes_hook", "friend", "generic_type_argument", "instantiate", "razor_event_binding", "subscribe", "unsubscribe"];
