...
internal static partial class ProgramRunner
{
    ...
    private static void PrintMcpUsage()
    {
        ...
        CommandErrorWriter.WriteStderr("Every present HTTP limit environment variable must be a positive integer in its displayed range; only an absent variable uses the default. POST handlers and SSE event streams use independent capacity gates.");
    }
