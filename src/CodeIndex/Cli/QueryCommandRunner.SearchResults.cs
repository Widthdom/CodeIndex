...
public static partial class QueryCommandRunner
{
    ...
    private static void WriteJsonStreamDone(int count, JsonSerializerOptions jsonOptions, bool interrupted = false, DbReader? reader = null, int? maxJsonBytes = null, int? firstOmittedResultBytes = null, int? omittedCount = null)
    {
