...
public partial class DbReader
{
        ...
        bool suppressDependencyNoise = false)
    {
        ...
        var retainedDependencySymbolFilterSql = suppressDependencyNoise
        ...
        sql += @"
            ...
            limited_edge_totals AS (
                ...
                FROM edge_totals
                ORDER BY " + dependencyReferenceOrderSql + @"
                LIMIT @limit
            ),
            ...
            distinct_edge_symbols AS (
                ...
                JOIN limited_edge_totals
                  ON limited_edge_totals.source_path = edges.source_path
                 AND limited_edge_totals.target_path = edges.target_path" + retainedDependencySymbolFilterSql + @"
            ),
            ...
            ORDER BY " + finalDependencyReferenceOrderSql;
        ...
        return RankDependencyResults(results, limit, suppressDependencyNoise);
    }
