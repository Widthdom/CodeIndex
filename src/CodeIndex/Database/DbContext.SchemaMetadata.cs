...
public partial class DbContext : IDisposable
{
    ...
    // Version 11 (#5188) invalidates C# local-function candidates written before lexical-scope
    // resolution. Version 10 (#5159) invalidates C# call candidates written before conservative method
    ...
    // バージョン 11 (#5188) では字句スコープ解決より前に書かれた C# local function candidate を
    // 無効化する。バージョン 10 (#5159) では保守的なメソッド引数個数の絞り込みより前に書かれた C# call
    // candidate を無効化する。
    ...
    public const int ReferenceIdentityContractVersion = 11;
    ...
    public const string UnknownExtensionDiagnosticsVersionMetaKey = "unknown_extension_diagnostics_version";
    public const string UnknownExtensionHasActionableExtensionlessFilesMetaKey = "unknown_extension_has_actionable_extensionless_files";
    public const int UnknownExtensionDiagnosticsVersion = 1;
