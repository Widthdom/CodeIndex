            ...
            CreateToolDefinition(
                ...
                new JsonObject
                {
                    ...
                    ["properties"] = new JsonObject
                    {
                        ...
                        ["kind"] = new JsonObject { ["type"] = "string", ["description"] = "Filter by call-graph reference kind (call, instantiate, subscribe, friend). Non-call-graph kinds — metadata (attribute, annotation), type-position (type_reference), and JS/TS discriminant narrowing (type_tag) — are rejected here; use `references` with the desired kind instead." },
            ...
            CreateToolDefinition(
                ...
                new JsonObject
                {
                    ...
                    ["properties"] = new JsonObject
                    {
                        ...
                        ["kind"] = new JsonObject { ["type"] = "string", ["description"] = "Filter by call-graph reference kind (call, instantiate, subscribe). Non-call-graph kinds — metadata (attribute, annotation), type-position (type_reference), and JS/TS discriminant narrowing (type_tag) — are rejected here; use `references` with the desired kind instead." },
                        ["rawKinds"] = new JsonObject { ["type"] = "boolean", ["description"] = "Preserve raw reference kinds instead of CLI logical grouping, matching `--raw-kinds`.", ["default"] = false },
