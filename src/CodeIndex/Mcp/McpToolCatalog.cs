            ...
            CreateToolDefinition(
                ...
                new JsonObject
                {
                    ...
                    ["properties"] = new JsonObject
                    {
                        ...
                        ["includeAllCycleNodes"] = new JsonObject { ["type"] = "boolean", ["description"] = $"Expand every path in returned SCCs instead of the default {QueryCommandRunner.DefaultDependencyCycleNodeLimit}-node sample. / 既定の {QueryCommandRunner.DefaultDependencyCycleNodeLimit} node sample ではなく、返却 SCC の全 path を展開する。", ["default"] = false },
