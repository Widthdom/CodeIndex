            ...
            CreateToolDefinition(
                ...
                new JsonObject
                {
                    ...
                    ["properties"] = new JsonObject
                    {
                        ...
                        ["summaryOnly"] = new JsonObject { ["type"] = "boolean", ["description"] = "Return bounded SCC metrics and node samples without the regular cycles collection. / 通常の cycles collection を省略し、上限付き SCC metrics と node sample を返す。", ["default"] = false },
