    ...
    private static bool TryGetExpectedJsonType(string toolName, string argumentName, out string expected)
    {
        ...
        expected = argumentName switch
        {
            "limit" or "offset" or "snippetLines" or "maxLineWidth" or "before" or "after" or
                ...
                "guardWindow" or "maxOutputBytes" or "maxResponseBytes" or "maxBytes" or "graphBudget" or "lineScanLimit" or "windowLines" or "windowBytes" => "integer",
            "multiline" or "check" or "excludeTests" or "includeGenerated" or "indexedOnly" or "rawQuery" or "noDedup" or "exactSubstring" or "tokenBoundary" or
