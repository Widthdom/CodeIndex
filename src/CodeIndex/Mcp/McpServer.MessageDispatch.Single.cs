        ...
        DeferredInitializeCommits? deferredInitializeCommits)
    {
        ...
        return method switch
        {
            ...
            _ => Task.FromResult<JsonNode>(CreateErrorResponse(
                ...
                suggestion: "Supported methods: initialize, tools/list, tools/call, resources/list, resources/templates/list, resources/read, prompts/list, prompts/get, logging/setLevel, ping, notifications/initialized, notifications/roots/list_changed, notifications/shutdown.",
                retrySafe: false)),
        };
    }
}
