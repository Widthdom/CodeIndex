...
public partial class McpServer
{
    ...
    private static IReadOnlySet<string> GetAllowedToolArguments(string toolName) => toolName switch
    {
        ...
        "deps" => new HashSet<string>(StringComparer.Ordinal) { "path", "reverse", "format", "cycles", "lang", "limit", "graphBudget", "cursor", "resolutionStates", "referenceKinds", "suppressNoise", "summaryOnly", "includeAllCycleNodes", "excludePaths", "excludeTests", "includeGenerated", "project", "solution" },
