...
public partial class McpServer
{
    ...
    private static IReadOnlySet<string> GetAllowedToolArguments(string toolName) => toolName switch
    {
        ...
        "callers" or "callees" => new HashSet<string>(StringComparer.Ordinal) { "query", "kind", "rawKinds", "includeQualifiedCommonCalls", "rankBy", "lang", "limit", "offset", "path", "excludePaths", "excludeTests", "includeGenerated", "exactName", "exact", "countOnly", "format", "project", "solution" },
