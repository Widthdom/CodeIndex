...
- Consolidated Python/Go extractor fixtures retain exact symbol/reference cardinality and source-line assertions when those were part of the original regression contract.
...
- 統合した Python/Go extractor fixture でも、元の回帰契約に含まれていた symbol/reference の厳密な件数と source line の assertion を維持します。
- `IndexCommandRunnerTests.RunBackfillFold_PublishedTrimmedBinary_SerializesSuccessAndErrorJson`
