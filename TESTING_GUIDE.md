...
- `IndexCommandRunner*Tests.cs`, `QueryCommandRunner*Tests.cs`, `ProgramCliTests.cs`, `InstallScriptTests.cs`
  ...
  Unused bucket and minimum-confidence JSON filters share one unused-symbol fixture.
...
- `IndexCommandRunner*Tests.cs`、`QueryCommandRunner*Tests.cs`、`ProgramCliTests.cs`、`InstallScriptTests.cs`
  ...
  unusedのbucket JSON filterとminimum-confidence JSON filterは1つのunused-symbol fixtureを共有してください。
