    ...
    private static DiffJsonResult CreateDiffResult()
        => new(
            ...
            new DiffSummaryJsonResult(
                ...
                [
                    new("data", true, true, true, 1, ["file_rows_changed"]),
                    new("schema", true, true, false, 0, []),
                    new("readiness_provenance", true, true, false, 0, []),
                    new("volatile_telemetry", true, false, false, 0, []),
                ]),
            ["src/Left.cs"],
            ["src/Right.cs"],
            null,
