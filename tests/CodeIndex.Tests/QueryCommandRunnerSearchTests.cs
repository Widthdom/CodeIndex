...
public partial class QueryCommandRunnerTests
{
    ...
    public void RunSearch_ListRecipesJsonIncludesBuiltInAuditMetadata_Issue3144()
    {
        ...
        Assert.Contains(dogfoodRegexQuery.GetProperty("risk_evidence").EnumerateArray(), evidence => evidence.GetString()!.Contains("suppressed by matched-member semantics", StringComparison.Ordinal));
        ...
        Assert.Contains(dogfoodRecipe.GetProperty("queries").EnumerateArray(), item => item.GetProperty("name").GetString() == "static-regex-api-qualified");
    ...
    public void RunSearch_JsonParserRecipesClassifyEveryRetainedResult_Issue5162()
    {
        ...
        try
        {
            ...
            void AssertRecipe(string queryName, IReadOnlyDictionary<string, string> expectedCategories)
            {
                ...
                var streamingPath = expectedCategories.Single(pair => pair.Value == "streaming_or_cancelable").Key;
    ...
    public void RunSearch_JsonTrustBoundaryClassifiesPrivateWritersAndUntrustedParsers_Issue4913()
    {
        ...
        try
        {
            ...
            AddFixture(
                ...
                public static class PrivateWriter
                {
            ...
            AddFixture(
                ...
                public static class PublicWriter
                {
                    public static JavaScriptEncoder Create()
                    {
                        // cdidx-audit: json-trust origin=public_api direction=write sensitivity=public trust=untrusted rationale=http_response_body
                        return JavaScriptEncoder.UnsafeRelaxedJsonEscaping;
                    }
                }
                """);
            ...
            AddFixture(
                ...
                public static class MixedBoundaryWriter
                {
                    public static JavaScriptEncoder Create()
                    {
                        // cdidx-audit: json-trust origin=private_local direction=write sensitivity=diagnostic trust=controlled rationale=private_diagnostic
                        var privateEncoder = JavaScriptEncoder.UnsafeRelaxedJsonEscaping;
                        // cdidx-audit: json-trust origin=public_api direction=write sensitivity=public trust=untrusted rationale=public_response
                        var publicEncoder = JavaScriptEncoder.UnsafeRelaxedJsonEscaping;
            ...
            AddFixture(
                ...
                public static class SameLineBlockInterveningWriter
                {
                    public static JavaScriptEncoder Create(bool skip)
                    {
                        // cdidx-audit: json-trust origin=private_local direction=write sensitivity=diagnostic trust=controlled rationale=next_operation_only
                        if (skip) { } return JavaScriptEncoder.UnsafeRelaxedJsonEscaping;
                    }
                }
                """);
            AddFixture(
                ...
                public static class SameLineMultipleWriter
                {
                    public static object Create()
                    {
                        // cdidx-audit: json-trust origin=private_local direction=write sensitivity=diagnostic trust=controlled rationale=first_operation_only
                        return (JavaScriptEncoder.UnsafeRelaxedJsonEscaping, JavaScriptEncoder.UnsafeRelaxedJsonEscaping);
                    }
                }
                """);
            AddFixture(
                ...
                public static class SameLinePriorGetterWriter
                {
                    public static object Create(Source source)
                    {
                        // cdidx-audit: json-trust origin=private_local direction=write sensitivity=diagnostic trust=controlled rationale=next_operation_only
                        return source.Value + JavaScriptEncoder.UnsafeRelaxedJsonEscaping;
                    }
                }
                """);
            AddFixture(
                ...
                public static class FirstNamedArgumentWriter
                {
                    public static JavaScriptEncoder Create()
                    {
                        // cdidx-audit: json-trust origin=private_local direction=write sensitivity=diagnostic trust=controlled rationale=first_argument_executes_first
                        return Consume(encoder: JavaScriptEncoder.UnsafeRelaxedJsonEscaping);
                    }
            ...
            AddFixture(
                ...
                public static class NullableDeclarationWriter
                {
                    public static JavaScriptEncoder? Create()
                    {
                        // cdidx-audit: json-trust origin=private_local direction=write sensitivity=diagnostic trust=controlled rationale=nullable_declaration_is_not_an_operand
            ...
            AddFixture(
                ...
                public static class ComparisonOperandWriter
                {
                    public static bool Create(object existing)
                    {
                        // cdidx-audit: json-trust origin=private_local direction=write sensitivity=diagnostic trust=controlled rationale=next_operation_only
                        return existing == JavaScriptEncoder.UnsafeRelaxedJsonEscaping;
                    }
                }
                """);
            AddFixture(
                ...
                public static class NestedGenericFirstArgumentWriter
                {
                    public static JavaScriptEncoder Create()
                    {
                        // cdidx-audit: json-trust origin=private_local direction=write sensitivity=diagnostic trust=controlled rationale=nested_generic_first_argument
                        return Consume<List<int>>(JavaScriptEncoder.UnsafeRelaxedJsonEscaping);
                    }
            ...
            AddFixture(
                ...
                public static class IndexerTargetWriter
                {
                    public static JavaScriptEncoder Create(JavaScriptEncoder[] sink, IndexHolder holder)
                    {
                        // cdidx-audit: json-trust origin=private_local direction=write sensitivity=diagnostic trust=controlled rationale=next_operation_only
                        sink[holder.Index] = JavaScriptEncoder.UnsafeRelaxedJsonEscaping;
                        return sink[holder.Index];
                    }
                }
                """);
            AddFixture(
                ...
                public sealed class ReceiverSink
                {
                    public ReceiverOptions Options => new();
                }
                ...
                public static class PropertyReceiverWriter
                {
                    public static void Create(ReceiverSink sink)
                    {
                        // cdidx-audit: json-trust origin=private_local direction=write sensitivity=diagnostic trust=controlled rationale=next_operation_only
                        sink.Options.Encoder = JavaScriptEncoder.UnsafeRelaxedJsonEscaping;
                    }
                }
                """);
            AddFixture(
                ...
                public sealed class SingleHopReceiverOptions
                {
                    public JavaScriptEncoder? Encoder { get; set; }
                }

                public static class SingleHopPropertyReceiverWriter
                {
                    private static SingleHopReceiverOptions Options => new();
            ...
            AddFixture(
                ...
                public static class AmbiguousWriter
                {
                    public static JavaScriptEncoder Create()
                    {
                        var fakeAnnotation = "// cdidx-audit: json-trust origin=private_local direction=write sensitivity=diagnostic trust=controlled rationale=string_literal_is_not_evidence";
                        Console.WriteLine(fakeAnnotation);
                        return JavaScriptEncoder.UnsafeRelaxedJsonEscaping;
                    }
                }
                """);
            AddFixture(
                ...
                public static class DirectionMismatchWriter
                {
                    public static JavaScriptEncoder Create()
                    {
                        // cdidx-audit: json-trust origin=network direction=read sensitivity=untrusted trust=untrusted rationale=inbound_payload
                        return JavaScriptEncoder.UnsafeRelaxedJsonEscaping;
                    }
                }
                """);
            AddFixture(
                ...
                public static class InvalidAnnotationWriter
                {
                    public static JavaScriptEncoder Create()
                    {
                        // cdidx-audit: json-trust origin=private_local direction=write sensitivity=diagnostic trust=controlled
                        return JavaScriptEncoder.UnsafeRelaxedJsonEscaping;
                    }
                }
                """);
            ...
            AddFixture(
                ...
                public static class NestedSerializerWriter
                {
                    public static string Create(object payload)
                    {
                        // cdidx-audit: json-trust origin=private_local direction=write sensitivity=diagnostic trust=controlled rationale=only_next_json_operation
                        return JsonSerializer.Serialize(JsonSerializer.Serialize(payload));
                    }
                }
                """);
            AddFixture(
                ...
                public static class CastSerializerWriter
                {
                    public static object Create(object payload)
                    {
                        // cdidx-audit: json-trust origin=private_local direction=write sensitivity=diagnostic trust=controlled rationale=cast_applies_after_serialization
                        return (object)JsonSerializer.Serialize(payload);
                    }
                }
                """);
            AddFixture(
                ...
                public static class MultilineSerializerWriter
                {
                    public static string Create(object payload)
                    {
                        // cdidx-audit: json-trust origin=private_local direction=write sensitivity=diagnostic trust=controlled rationale=continued_assignment_prefix
                        var json =
            ...
            AddFixture(
                ...
                public sealed class PropertyInvocationSource
                {
                    public PropertyInvocationBuilder Factory => new();
                }

                public sealed class PropertyInvocationBuilder
                {
                    public string Build(string json) => json;
                }

                public static class PropertyInvocationReceiverWriter
                {
                    public static string Create(PropertyInvocationSource source, object payload)
                    {
                        // cdidx-audit: json-trust origin=private_local direction=write sensitivity=diagnostic trust=controlled rationale=property_getter_executes_first
                        return source.Factory.Build(JsonSerializer.Serialize(payload));
                    }
                }
                """);
            AddFixture(
            ...
            AddFixture(
                ...
                {
                #if(false)
                    // cdidx-audit: json-trust origin=private_local direction=write sensitivity=diagnostic trust=controlled rationale=inactive_parenthesized_annotation
                #endif
                    public static string Create(object payload) => JsonSerializer.Serialize(payload);
                }
                """);
            ...
            AddFixture(
                ...
                public sealed class RepeatedAssignmentBuilder
                {
                    public RepeatedAssignmentBuilder Build(string json) => this;
                }

                public static class RepeatedAssignmentPropertyReceiverWriter
                {
                    private static RepeatedAssignmentBuilder Factory { get; set; } = new();

                    public static void Create(object payload)
                    {
                        // cdidx-audit: json-trust origin=private_local direction=write sensitivity=diagnostic trust=controlled rationale=repeated_assignment_property_getter_executes_first
                        Factory = Factory.Build(JsonSerializer.Serialize(payload));
                    }
                }
                """);
            AddFixture(
                ...
                public static class ExplicitUtf8Writer
                {
                    public static void Create(Stream stream)
                    {
                        // cdidx-audit: json-trust origin=private_local direction=write sensitivity=diagnostic trust=controlled rationale=private_stream_writer
            ...
            AddFixture(
                ...
                public static class MultilineExplicitUtf8Writer
                {
                    public static void Create(Stream stream)
                    {
                        // cdidx-audit: json-trust origin=private_local direction=write sensitivity=diagnostic trust=controlled rationale=multiline_typed_declaration
            ...
            AddFixture(
                ...
                public static class LongMultilineUtf8Writer
                {
                    public static void Create(Stream stream)
                    {
                        // cdidx-audit: json-trust origin=private_local direction=write sensitivity=diagnostic trust=controlled rationale=bounded_statement_continuation
                        using
                            var
                                writer
                                    =
            ...
            AddFixture(
                ...
                public static class ExpressionBodiedUtf8Writer
                {
                    // cdidx-audit: json-trust origin=private_local direction=write sensitivity=diagnostic trust=controlled rationale=expression_bodied_private_writer
            ...
            AddFixture(
                ...
                public sealed record GenericWriterHolder<T>(T Value);

                public static class GenericReturnUtf8Writer
                {
                    // cdidx-audit: json-trust origin=private_local direction=write sensitivity=diagnostic trust=controlled rationale=generic_return_private_writer
            ...
            AddFixture(
                ...
                public sealed record SplitGenericWriterHolder<T>(T Value);
                ...
                public static class SplitGenericReturnUtf8Writer
                {
                    ...
                    public static SplitGenericWriterHolder<
            ...
            AddFixture(
                ...
                public static class CrossQueryWriter
                {
            ...
            foreach (var (path, origin, rationale) in new[]
                     {
                         ("src/external-parser.cs", "external", "plugin_payload"),
                         ("src/network-parser.cs", "network", "http_request_body"),
                     ...
                     })
            {
                AddFixture(
                    ...
                    public static class Parser
                    {
                        public static JsonDocument Parse(string payload)
                        {
                            // cdidx-audit: json-trust origin={{origin}} direction=read sensitivity=untrusted trust=untrusted rationale={{rationale}}
                            return JsonDocument.Parse(payload);
                        }
                    }
                    """);
            ...
            var (crossQueryExitCode, crossQueryStdout, crossQueryStderr) = CaptureConsole(() => QueryCommandRunner.RunSearch(
                [
                    ...
                    "--include-query", "utf8-json-writer",
            ...
            var (guardedExitCode, guardedStdout, guardedStderr) = CaptureConsole(() => QueryCommandRunner.RunSearch(
                ...
                _jsonOptions));
            var (guardedCountExitCode, guardedCountStdout, guardedCountStderr) = CaptureConsole(() => QueryCommandRunner.RunSearch(
                [
                    "--recipe", "dogfood-risk-patterns/relaxed-json-encoder",
                    "--db", dbPath,
                    "--path", "src/private-writer.cs",
            ...
            var (projectedExitCode, projectedStdout, projectedStderr) = CaptureConsole(() => QueryCommandRunner.RunSearch(
                ...
                _jsonOptions));
            var (compactSummaryExitCode, compactSummaryStdout, compactSummaryStderr) = CaptureConsole(() => QueryCommandRunner.RunSearch(
                [
                    "--recipe", "dogfood-risk-patterns/relaxed-json-encoder",
                    "--db", dbPath,
                    "--path", "src/private-writer.cs",
            ...
            {
                var query = Assert.Single(document.RootElement.GetProperty("queries").EnumerateArray());
                Assert.Equal(21, query.GetProperty("count").GetInt32());
                ...
                Assert.Contains(
                    trustClassifier.GetProperty("evidence_fields").EnumerateArray(),
                    field => field.GetString() == "source_annotation");
                Assert.Contains(
                    trustClassifier.GetProperty("evidence_fields").EnumerateArray(),
                    field => field.GetString() == "recipe_query_direction");
                ...
                AssertJsonTrustClassification(
                    Assert.Single(results, result => result.GetProperty("path").GetString() == "src/private-writer.cs"),
                    "controlled_private_writer",
                    "origin:private_local",
                    "trust:controlled");
                AssertJsonTrustClassification(
                    Assert.Single(results, result => result.GetProperty("path").GetString() == "src/public-writer.cs"),
                ...
                AssertJsonTrustClassification(
                    Assert.Single(results, result => result.GetProperty("path").GetString() == "src/same-line-block-intervening-writer.cs"),
                    "ambiguous_trust",
                    "rationale:annotation_not_bound_to_operation",
                    "annotation_status:not_adjacent");
                AssertJsonTrustClassification(
                    Assert.Single(results, result => result.GetProperty("path").GetString() == "src/same-line-multiple-writer.cs"),
                    "ambiguous_trust",
                    "annotation_status:mixed_boundaries",
                    "boundary_categories:ambiguous_trust,controlled_private_writer");
                AssertJsonTrustClassification(
                    Assert.Single(results, result => result.GetProperty("path").GetString() == "src/same-line-prior-getter-writer.cs"),
                    "ambiguous_trust",
                    "rationale:annotation_not_bound_to_operation",
                    "annotation_status:not_adjacent");
                AssertJsonTrustClassification(
                    Assert.Single(results, result => result.GetProperty("path").GetString() == "src/first-named-argument-writer.cs"),
                    "controlled_private_writer",
                    "rationale:first_argument_executes_first",
                    "annotation_status:valid");
                AssertJsonTrustClassification(
                    Assert.Single(results, result => result.GetProperty("path").GetString() == "src/nullable-declaration-writer.cs"),
                    "controlled_private_writer",
                    "rationale:nullable_declaration_is_not_an_operand",
                    "annotation_status:valid");
                AssertJsonTrustClassification(
                    Assert.Single(results, result => result.GetProperty("path").GetString() == "src/comparison-operand-writer.cs"),
                    "ambiguous_trust",
                    "rationale:annotation_not_bound_to_operation",
                    "annotation_status:not_adjacent");
                AssertJsonTrustClassification(
                    Assert.Single(results, result => result.GetProperty("path").GetString() == "src/nested-generic-first-argument-writer.cs"),
                    "controlled_private_writer",
                    "rationale:nested_generic_first_argument",
                    "annotation_status:valid");
                AssertJsonTrustClassification(
                    Assert.Single(results, result => result.GetProperty("path").GetString() == "src/indexer-target-writer.cs"),
                    "ambiguous_trust",
                    "rationale:annotation_not_bound_to_operation",
                    "annotation_status:not_adjacent");
                AssertJsonTrustClassification(
                    Assert.Single(results, result => result.GetProperty("path").GetString() == "src/property-receiver-writer.cs"),
                    "ambiguous_trust",
                    "rationale:annotation_not_bound_to_operation",
                    "annotation_status:not_adjacent");
                AssertJsonTrustClassification(
                    Assert.Single(results, result => result.GetProperty("path").GetString() == "src/single-hop-property-receiver-writer.cs"),
                    "ambiguous_trust",
                    "rationale:annotation_not_bound_to_operation",
                    "annotation_status:not_adjacent");
                AssertJsonTrustClassification(
                ...
                AssertJsonTrustClassification(
                    Assert.Single(results, result => result.GetProperty("path").GetString() == "src/direction-mismatch-writer.cs"),
                    "ambiguous_trust",
                    "direction:read",
                    "annotation_status:direction_mismatch");
                AssertJsonTrustClassification(
                    Assert.Single(results, result => result.GetProperty("path").GetString() == "src/invalid-annotation-writer.cs"),
                    "ambiguous_trust",
                    "origin:unknown",
            ...
            Assert.Equal(string.Empty, guardedStderr);
            using (var document = ParseJsonOutput(guardedStdout))
            {
                var query = Assert.Single(document.RootElement.GetProperty("queries").EnumerateArray());
            ...
            Assert.Equal(CommandExitCodes.Success, guardedCountExitCode);
            Assert.Equal(string.Empty, guardedCountStderr);
            using (var document = ParseJsonOutput(guardedCountStdout))
            {
                var query = Assert.Single(document.RootElement.GetProperty("queries").EnumerateArray());
                AssertJsonTrustClassifierCounts(query, ("controlled_private_writer", 1));
            }
            ...
            using (var document = ParseJsonOutput(parserStdout))
            {
                var query = Assert.Single(document.RootElement.GetProperty("queries").EnumerateArray());
                Assert.Equal(3, query.GetProperty("count").GetInt32());
                AssertJsonTrustClassifierCounts(query, ("untrusted_parser", 3));

                foreach (var result in query.GetProperty("results").EnumerateArray())
                {
                    AssertJsonTrustClassification(
                        result,
                        "untrusted_parser",
            ...
            using (var document = ParseJsonOutput(nestedStdout))
            {
                var query = Assert.Single(document.RootElement.GetProperty("queries").EnumerateArray());
                AssertJsonTrustClassifierCounts(
                    query,
                ...
                AssertJsonTrustClassification(
                    ...
                    "ambiguous_trust",
                    "rationale:multiple_trust_boundaries",
                    "annotation_status:mixed_boundaries",
                    "match_site_count:2",
                    "boundary_categories:ambiguous_trust,controlled_private_writer");
                AssertJsonTrustClassification(
                    Assert.Single(results, result => result.GetProperty("path").GetString() == "src/cast-serializer-writer.cs"),
                    "controlled_private_writer",
                    "rationale:cast_applies_after_serialization",
                    "annotation_status:valid");
                AssertJsonTrustClassification(
                ...
                AssertJsonTrustClassification(
                    ...
                    "annotation_status:not_adjacent");
                AssertJsonTrustClassification(
                    Assert.Single(results, result => result.GetProperty("path").GetString() == "src/repeated-assignment-property-receiver-writer.cs"),
                    "ambiguous_trust",
                    "rationale:annotation_not_bound_to_operation",
                    "annotation_status:not_adjacent");
            }
            ...
            Assert.Equal(string.Empty, utf8Stderr);
            using (var document = ParseJsonOutput(utf8Stdout))
            {
                ...
                AssertJsonTrustClassification(
                    ...
                    "controlled_private_writer",
                    "rationale:private_stream_writer",
                    "annotation_status:valid");
                AssertJsonTrustClassification(
                    Assert.Single(results, result => result.GetProperty("path").GetString() == "src/multiline-explicit-utf8-writer.cs"),
                    "controlled_private_writer",
                    "rationale:multiline_typed_declaration",
                    "annotation_status:valid");
                AssertJsonTrustClassification(
                    Assert.Single(results, result => result.GetProperty("path").GetString() == "src/long-multiline-utf8-writer.cs"),
                    "controlled_private_writer",
                    "rationale:bounded_statement_continuation",
                    "annotation_status:valid");
                AssertJsonTrustClassification(
                    Assert.Single(results, result => result.GetProperty("path").GetString() == "src/expression-bodied-utf8-writer.cs"),
                    "controlled_private_writer",
                    "rationale:expression_bodied_private_writer",
                    "annotation_status:valid");
                AssertJsonTrustClassification(
            ...
            Assert.Equal(CommandExitCodes.Success, crossQueryExitCode);
            Assert.Equal(string.Empty, crossQueryStderr);
            using (var document = ParseJsonOutput(crossQueryStdout))
            {
                var queries = document.RootElement.GetProperty("queries").EnumerateArray().ToArray();
                var serializerQuery = Assert.Single(
                    queries,
                    query => query.GetProperty("name").GetString() == "json-serializer-serialize");
                var writerQuery = Assert.Single(
                    queries,
                    query => query.GetProperty("name").GetString() == "utf8-json-writer");
                AssertJsonTrustClassifierCounts(serializerQuery, ("controlled_private_writer", 1));
                AssertJsonTrustClassification(
                    Assert.Single(serializerQuery.GetProperty("results").EnumerateArray()),
                    "controlled_private_writer",
                    "rationale:first_selected_json_operation_only",
                    "annotation_status:valid");
            ...
            Assert.Equal(CommandExitCodes.Success, compactSummaryExitCode);
            Assert.Equal(string.Empty, compactSummaryStderr);
            using (var document = ParseJsonOutput(compactSummaryStdout))
            {
                var query = Assert.Single(document.RootElement.GetProperty("queries").EnumerateArray());
                Assert.False(query.TryGetProperty("classifier_counts", out _));
                Assert.False(query.TryGetProperty("results", out _));
            }
        }
        finally
        {
        ...
        static void AssertJsonTrustClassifierCounts(
            JsonElement query,
            params (string Category, int Count)[] expected)
        {
            var counts = query.GetProperty("classifier_counts").EnumerateArray().ToArray();
            var trustCounts = Assert.Single(counts, count => count.GetProperty("classifier").GetString() == "json_trust_boundary");
            var categories = trustCounts.GetProperty("categories").EnumerateArray().ToArray();

            foreach (var (category, count) in expected)
            {
                Assert.Contains(categories, item =>
    ...
    [Fact]
    public void RunSearch_JsonTrustBoundaryCacheReusesExhaustedActualPrefix_Issue4913()
    {
        ...
        try
        {
            ...
            const string highChunk = """
                ...
                """;
            const string laterHighChunk = """
                // cdidx-audit: json-trust origin=public_api direction=write sensitivity=public trust=untrusted rationale=also_beyond_source_budget
                var laterHigh = JavaScriptEncoder.UnsafeRelaxedJsonEscaping;
                """;
            ...
            using (var db = new DbContext(DbOpenIntent.WriteIndex, dbPath))
            {
                ...
                var fileId = writer.UpsertFile(new FileRecord
                {
                    Path = path,
                    Lang = "csharp",
                    Size = lowChunk.Length + highChunk.Length + laterHighChunk.Length,
                    Lines = 8,
            ...
            Assert.Contains(8, results[1].GetProperty("match_lines").EnumerateArray().Select(line => line.GetInt32()));
            AssertJsonTrustClassification(
                results[1],
                "ambiguous_trust",
                "rationale:missing_explicit_trust_annotation");
            Assert.Contains(3, results[2].GetProperty("match_lines").EnumerateArray().Select(line => line.GetInt32()));
            AssertJsonTrustClassification(
                results[2],
                "controlled_private_writer",
    ...
    [Fact]
    public void RunSearch_JsonTrustBoundaryIgnoresDeduplicatedOverlapFacets_Issue4913()
    {
        var projectRoot = TestProjectHelper.CreateTempProject("cdidx_search_json_trust_overlap_4913");
        try
        {
            var dbPath = TestProjectHelper.CreateProjectDb(projectRoot);
            const string path = "src/overlap-writer.cs";
            var lines = Enumerable.Range(1, 220)
                .Select(line => $"// filler {line}")
                .ToArray();
            lines[0] = "using System.Text.Encodings.Web;";
            lines[74] = "// cdidx-audit: json-trust origin=public_api direction=write sensitivity=public trust=untrusted rationale=external_overlap";
            lines[75] = "var externalEncoder = JavaScriptEncoder.UnsafeRelaxedJsonEscaping;";
            lines[140] = "// cdidx-audit: json-trust origin=private_local direction=write sensitivity=diagnostic trust=controlled rationale=private_retained";
            lines[141] = "var privateEncoder = JavaScriptEncoder.UnsafeRelaxedJsonEscaping;";
            ...
            using var document = ParseJsonOutput(stdout);
            var query = Assert.Single(document.RootElement.GetProperty("queries").EnumerateArray());
            var retainedPrivateResult = Assert.Single(
                query.GetProperty("results").EnumerateArray(),
                result => result.GetProperty("match_lines").EnumerateArray().Any(line => line.GetInt32() == 142));
            AssertJsonTrustClassification(
                retainedPrivateResult,
                "controlled_private_writer",
                "rationale:private_retained",
                "annotation_status:valid");
        }
        finally
        {
    ...
    public void RunSearch_ListRecipesNamesJsonEmitsDeterministicSmallPayload_Issue4064()
    {
        ...
        using var capDocument = ParseJsonOutput(capStdout);
        Assert.Equal(
            "E028_RESPONSE_BUDGET_TOO_SMALL",
            capDocument.RootElement.GetProperty("error_code").GetString());
        Assert.Equal("search", capDocument.RootElement.GetProperty("command").GetString());
        ...
        Assert.Equal(string.Empty, compactNamesCapStderr);
        using var compactCapDocument = ParseJsonOutput(compactNamesCapStdout);
        Assert.Equal(
            "E028_RESPONSE_BUDGET_TOO_SMALL",
            compactCapDocument.RootElement.GetProperty("error_code").GetString());
    }

    [Fact]
    public void RunRecipeList_ResponseBudgetFailuresAreJsonAndExactMinimumIsRetryable_Issue4909()
    {
        var (capExitCode, capStdout, capStderr) = CaptureConsole(() => QueryCommandRunner.RunRecipeList(
            ["--names", "--json", "--max-json-bytes", "1"],
            _jsonOptions));
        ...
        Assert.Equal("recipes", capError.GetProperty("command").GetString());
        Assert.StartsWith("cdidx recipes ", capError.GetProperty("usage").GetString(), StringComparison.Ordinal);
        ...
        var (exactExitCode, exactStdout, exactStderr) = CaptureConsole(() => QueryCommandRunner.RunRecipeList(
            [
                "--names", "--json", "--max-json-bytes",
        ...
        using var exactDocument = ParseJsonOutput(exactStdout);
        Assert.Contains(
            exactDocument.RootElement.GetProperty("names").EnumerateArray(),
            name => name.GetString() == "risky-code");

        var (zeroExitCode, zeroStdout, zeroStderr) = CaptureConsole(() => QueryCommandRunner.RunRecipeList(
            ["--names", "--json", "--max-json-bytes", "0"],
            _jsonOptions));
        ...
        Assert.Equal("recipes", zeroError.GetProperty("command").GetString());
    ...
    public void RunSearch_SafetyRecipesApplyOperationAndPolaritySemantics_Issue4911()
    {
        ...
        try
        {
            ...
            TestProjectHelper.InsertIndexedFile(
                ...
                public static class RegexRisk
                {
                    public static bool Match(string input) => Regex.IsMatch(input, "token");
                }
                """);
            TestProjectHelper.InsertIndexedFile(
                dbPath,
                "src/regex-unresolved.cs",
                "csharp",
                """
                using System.Text.RegularExpressions;

                public static class RegexUnresolved
                {
                    public static object Inspect(string input) => Regex.CustomOperation(input);
                }
                """);
            TestProjectHelper.InsertIndexedFile(
                dbPath,
            ...
            TestProjectHelper.InsertIndexedFile(
                dbPath,
                "src/regex-qualified-safe.cs",
                "csharp",
                """
                public static class RegexQualifiedSafe
                {
                    public static string Escape(string input) => global::System.Text.RegularExpressions.Regex.Escape(input);
                }
                """);
            TestProjectHelper.InsertIndexedFile(
                dbPath,
                "src/regex-qualified-risk.cs",
                "csharp",
                """
            ...
            TestProjectHelper.InsertIndexedFile(
                dbPath,
                "src/regex-mixed-chunk.cs",
                "csharp",
                """
                using System.Text.RegularExpressions;

                public static class RegexMixedChunk
                {
                    public static bool Match(string input)
                    {
                        var escaped1 = Regex.Escape(input);
                        var escaped2 = Regex.Escape(escaped1);
                        var escaped3 = Regex.Escape(escaped2);
                        var escaped4 = Regex.Escape(escaped3);
                        var escaped5 = Regex.Escape(escaped4);
                        var escaped6 = Regex.Escape(escaped5);
                        var escaped7 = Regex.Escape(escaped6);
                        var escaped8 = Regex.Escape(escaped7);
                        return Regex.IsMatch(escaped8, "token");
                    }
                }
                """);
            TestProjectHelper.InsertIndexedFile(
                dbPath,
                "src/regex-construction.cs",
                "csharp",
                """
                using System.Text.RegularExpressions;

                public static class RegexConstruction
                {
                    public static Regex Build(string input) => new Regex("^" + Regex.Escape(input));
                }
                """);
            TestProjectHelper.InsertIndexedFile(
                dbPath,
                "src/shell-disabled.cs",
                "csharp",
                """
                using System.Diagnostics;
            ...
            TestProjectHelper.InsertIndexedFile(
                dbPath,
                "src/shell-enabled.cs",
                "csharp",
                """
                using System.Diagnostics;

                public static class ShellEnabled
                {
                    public static ProcessStartInfo Build() => new() { UseShellExecute = true };
                }
                """);
            TestProjectHelper.InsertIndexedFile(
                dbPath,
                "src/shell-propagated.cs",
                "csharp",
                """
                using System.Diagnostics;

                public static class ShellPropagated
                {
            ...
            var recipeArgs = new[]
            {
                ...
                "--include-query", "static-regex-api,static-regex-api-qualified,process-shell-execute",
                "--db", dbPath,
                "--json",
                "--limit", "20",
                "--lang", "csharp"
            };
            var (runExitCode, runStdout, runStderr) = CaptureConsole(() => QueryCommandRunner.RunSearch(recipeArgs, _jsonOptions));
            var (countExitCode, countStdout, countStderr) = CaptureConsole(() => QueryCommandRunner.RunSearch(
                [.. recipeArgs, "--format", "count"],
                _jsonOptions));
            var (constructionExitCode, constructionStdout, constructionStderr) = CaptureConsole(() => QueryCommandRunner.RunSearch(
                ["--recipe", "dotnet-risk-patterns/regex-construction", "--db", dbPath, "--json", "--limit", "20", "--lang", "csharp"],
                _jsonOptions));
            ...
            {
                var queries = document.RootElement.GetProperty("queries").EnumerateArray().ToArray();
                var regexQuery = Assert.Single(queries, query => query.GetProperty("name").GetString() == "static-regex-api");
            ...
            Assert.Equal(string.Empty, constructionStderr);
            using (var document = ParseJsonOutput(constructionStdout))
            {
                var query = Assert.Single(document.RootElement.GetProperty("queries").EnumerateArray());
        ...
        {
            var result = Assert.Single(query.GetProperty("results").EnumerateArray(), item => item.GetProperty("path").GetString() == path);
            var classification = Assert.Single(result.GetProperty("audit_classifications").EnumerateArray());
            Assert.Equal(expectedClassifier, classification.GetProperty("classifier").GetString());
            Assert.Equal(expectedCategory, classification.GetProperty("category").GetString());
            Assert.Contains(classification.GetProperty("evidence").EnumerateArray(), evidence => evidence.GetString() == expectedEvidence);
        }

        static void AssertClassifierCategories(JsonElement query, string name, params string[] expectedCategories)
        {
            var classifier = Assert.Single(
                query.GetProperty("classifiers").EnumerateArray(),
                item => item.GetProperty("name").GetString() == name);
            var categories = classifier.GetProperty("categories").EnumerateArray()
    ...
    public void RunSearch_RecipeCountSummaryOnlyJsonOmitsRecipeMetadataAndReportsFreshness_Issues4064_4118()
    {
        ...
        try
        {
            ...
            Assert.Equal(string.Empty, aggregationCapStderr);
            using var aggregationCapDocument = ParseJsonOutput(aggregationCapStdout);
            Assert.Equal(
                CommandErrorCodes.ResponseBudgetTooSmall,
                aggregationCapDocument.RootElement.GetProperty("error_code").GetString());
            Assert.Equal("search", aggregationCapDocument.RootElement.GetProperty("command").GetString());
        }
        finally
        {
            TestProjectHelper.DeleteDirectory(projectRoot);
    ...
    public void RunSearch_MaxJsonBytesBoundsCompactOutput_Issue4119()
    {
        ...
        try
        {
            ...
            Assert.Equal(
                CommandErrorCodes.ResponseBudgetTooSmall,
                zeroDocument.RootElement.GetProperty("error_code").GetString());
            Assert.Equal("search", zeroDocument.RootElement.GetProperty("command").GetString());
            ...
            Assert.Equal(string.Empty, groupedZeroStderr);
            using var groupedZeroDocument = ParseJsonOutput(groupedZeroStdout);
            Assert.Equal(
                CommandErrorCodes.ResponseBudgetTooSmall,
                groupedZeroDocument.RootElement.GetProperty("error_code").GetString());
            Assert.Equal("search", groupedZeroDocument.RootElement.GetProperty("command").GetString());
        }
        finally
        {
            TestProjectHelper.DeleteDirectory(projectRoot);
    ...
    public void RunSearch_NdjsonByteCapReportsPartialOrRejectsUndersizedTerminal_Issues3904_4561()
    {
        ...
        try
        {
            ...
            using var zeroDocument = ParseJsonOutput(zeroStdout);
            var zeroError = zeroDocument.RootElement;
            Assert.Equal(CommandErrorCodes.ResponseBudgetTooSmall, zeroError.GetProperty("error_code").GetString());
            Assert.Equal("search", zeroError.GetProperty("command").GetString());
            Assert.Equal(1, zeroError.GetProperty("requested_bytes").GetInt64());
            Assert.True(zeroError.GetProperty("minimum_required_bytes_known").GetBoolean());
            Assert.True(zeroError.GetProperty("minimum_required_bytes_uncertain").GetBoolean());

            var (resultsOnlyExitCode, resultsOnlyStdout, resultsOnlyStderr) = CaptureConsole(() => QueryCommandRunner.RunSearch(
                ["token", "--db", dbPath, "--json=ndjson", "--results-only", "--max-json-bytes", "1"],
                _jsonOptions));

            Assert.Equal(CommandExitCodes.UsageError, resultsOnlyExitCode);
            Assert.Equal(string.Empty, resultsOnlyStderr);
            using var resultsOnlyDocument = ParseJsonOutput(resultsOnlyStdout);
            var resultsOnlyError = resultsOnlyDocument.RootElement;
            Assert.Equal(
                CommandErrorCodes.ResponseBudgetTooSmall,
                resultsOnlyError.GetProperty("error_code").GetString());
            Assert.Equal("search", resultsOnlyError.GetProperty("command").GetString());
            Assert.True(resultsOnlyError.GetProperty("minimum_required_bytes_known").GetBoolean());
            Assert.False(resultsOnlyError.GetProperty("minimum_required_bytes_uncertain").GetBoolean());
        }
        finally
        {
            TestProjectHelper.DeleteDirectory(projectRoot);
    ...
    [Fact]
    public void RunSearch_PrettyIssueDraftBudgetRecommendationIsRetryable_Issue4909()
    {
        var projectRoot = TestProjectHelper.CreateTempProject("cdidx_pretty_issue_draft_budget_4909");
        try
        {
            var dbPath = TestProjectHelper.CreateProjectDb(projectRoot);
            TestProjectHelper.InsertIndexedFile(
                ...
                "src/pretty.cs",
                "csharp",
                "public sealed class PrettyIssue4909Needle { }\n");
            var prettyJsonOptions = new JsonSerializerOptions(_jsonOptions)
            {
                WriteIndented = true,
            };
            var args = new[]
            {
                "PrettyIssue4909Needle",
                "--db", dbPath,
                "--format", "issue-drafts",
                "--exact-substring",
                "--limit", "1",
            ...
            var (exitCode, stdout, stderr) = CaptureConsole(() =>
                QueryCommandRunner.RunSearch(args, prettyJsonOptions));

            Assert.Equal(CommandExitCodes.UsageError, exitCode);
            Assert.Equal(string.Empty, stderr);
            using var errorDocument = JsonDocument.Parse(stdout);
            var recommendedBytes = errorDocument.RootElement
                .GetProperty("retry")
                .GetProperty("recommended_bytes")
                .GetInt64();

            var retryArgs = args.ToArray();
            retryArgs[^1] = recommendedBytes.ToString(
                System.Globalization.CultureInfo.InvariantCulture);
            var (retryExitCode, retryStdout, retryStderr) = CaptureConsole(() =>
                QueryCommandRunner.RunSearch(retryArgs, prettyJsonOptions));
            ...
            Assert.Single(retryDocument.RootElement.GetProperty("drafts").EnumerateArray());
        }
        finally
        {
            TestProjectHelper.DeleteDirectory(projectRoot);
    ...
    public void RunSearch_FilesystemTraversalRecipeResolvesEnumerationOptionsStructurally_Issue4912()
    {
        ...
        try
        {
            ...
            TestProjectHelper.InsertIndexedFile(
                dbPath,
                "src/named-options.cs",
                "csharp",
                """
                public sealed class NamedOptionsTraversal
                {
                    public void Run(string root)
                    {
                        var localOptions = new EnumerationOptions();
                        foreach (var path in Directory.EnumerateFiles(
                            enumerationOptions: localOptions,
                            searchPattern: "*",
                            path: root))
                            Console.WriteLine(path);
                    }
            ...
            TestProjectHelper.InsertIndexedFile(
                dbPath,
                "src/shadowed-options.cs",
                "csharp",
                """
                public sealed class ShadowedOptionsTraversal
                {
                    private static readonly EnumerationOptions options = new();

                    public void Run(string root, SearchOption options)
                    {
                        foreach (var path in Directory.EnumerateFiles(root, "*", options))
                            Console.WriteLine(path);
                    }
            ...
            Assert.True(
                query.GetProperty("count").GetInt32() == 3,
            ...
            Assert.Contains(results, result => result.GetProperty("path").GetString() == "src/shadowed-options.cs");
            ...
            Assert.DoesNotContain(query.GetProperty("top_files").EnumerateArray(), item => item.GetProperty("path").GetString() == "src/named-options.cs");
        ...
        try
        {
            ...
            TestProjectHelper.InsertIndexedFile(
                ...
                public static class Reads
                {
                    ...
                    public static string NameOnlyHelper(string path)
                    {
                        MisleadingBounded(path);
                        return File.ReadAllText(path);
                    }

                    private static void MisleadingBounded(string path)
                        => Console.WriteLine(path, MaxBytes);

                    public static string NamedHelperMismatch(string path, string cache)
                    {
                        PrepareNamed(target: path, other: cache);
                        return File.ReadAllText(path);
                    }

                    private static void PrepareNamed(string other, string target)
                    {
                        BoundedFile.WriteAllText(other, MaxBytes);
                    }

                    public static string SwitchSections(string path, int kind)
                    {
                        switch (kind)
                        {
                            case 0:
                    ...
                    public static string ConditionalSizeSource(string path, bool inspectFile)
                    {
                        var length = inspectFile ? new FileInfo(path).Length : 0;
                        if (length > MaxBytes)
                            throw new InvalidDataException();
                        return File.ReadAllText(path);
                    }

                    public static string CommentSizeSource(string path, Stream other)
                    {
                    ...
                    public static string ReorderedNamedRead(string path)
                    {
                        var length = new FileInfo(path).Length;
                        if (length > MaxBytes)
                            throw new InvalidDataException();
                        return File.ReadAllText(encoding: Encoding.UTF8, path: path);
                    }
            ...
            Assert.True(
                query.GetProperty("count").GetInt32() == 16,
            ...
            Assert.DoesNotContain(results, result => result.GetProperty("enclosing_symbol_name").GetString() == "ReorderedNamedRead");
            ...
            Assert.Contains(results, result => result.GetProperty("enclosing_symbol_name").GetString() == "NameOnlyHelper");
            Assert.Contains(results, result => result.GetProperty("enclosing_symbol_name").GetString() == "NamedHelperMismatch");
            Assert.Contains(results, result => result.GetProperty("enclosing_symbol_name").GetString() == "SwitchSections");
            Assert.Contains(results, result => result.GetProperty("enclosing_symbol_name").GetString() == "ConditionalSizeSource");
            Assert.Contains(results, result => result.GetProperty("enclosing_symbol_name").GetString() == "CommentSizeSource");
    ...
    public void RunSearch_RecipeIssueDraftsSummaryOnlyEmitsCompactMetadataAndFreshness_Issue4118()
    {
        ...
        try
        {
            ...
            Assert.True(root.GetProperty("total_count_authoritative").GetBoolean());
            ...
            Assert.Contains(freshness.GetProperty("clean_zero_match_query_names").EnumerateArray(), name => name.GetString() == "unbounded-json-parse");
            Assert.Empty(freshness.GetProperty("stale_query_names").EnumerateArray());
            Assert.Equal("raw-diagnostic-echo", draft.GetProperty("query_name").GetString());
            Assert.Equal("low", draft.GetProperty("confidence").GetString());
            Assert.True(draft.GetProperty("file_count").GetInt32() > 0);
            Assert.False(draft.TryGetProperty("body", out _));
            Assert.False(draft.TryGetProperty("source", out _));
            Assert.False(draft.TryGetProperty("evidence", out _));
        }
        finally
        {
            TestProjectHelper.DeleteDirectory(projectRoot);
    ...
    [Fact]
    public void RunSearch_RecipeIssueDraftSummaryBudgetsWholeUtf8RowsAndPreservesFullOutput_Issue5058()
    {
        var projectRoot = TestProjectHelper.CreateTempProject("cdidx_search_recipe_issue_draft_summary_5058");
        try
        {
            var dbPath = TestProjectHelper.CreateProjectDb(projectRoot);
            ...
            TestProjectHelper.InsertFreshIndexedFile(
                ...
                "src/broad-catch.cs",
                "csharp",
                "try { } catch (Exception ex) { Console.Error.WriteLine(ex.Message); }\n");

            string[] SummaryArgs(params string[] extraArgs) =>
            [
                "--recipe", "risky-code",
                "--include-query", "raw-diagnostic-echo",
                "--include-query", "broad-exception-catch",
            ...
            var relaxedJsonOptions = new JsonSerializerOptions(_jsonOptions)
            {
                Encoder = JavaScriptEncoder.UnsafeRelaxedJsonEscaping,
            };

            var (summaryExitCode, summaryStdout, summaryStderr) = CaptureConsole(() => QueryCommandRunner.RunSearch(
                SummaryArgs("--max-json-bytes", "120000"),
                relaxedJsonOptions));

            Assert.Equal(CommandExitCodes.Success, summaryExitCode);
            Assert.Equal(string.Empty, summaryStderr);
            Assert.True(Encoding.UTF8.GetByteCount(summaryStdout) <= 120000);
            using var summaryDocument = ParseJsonOutput(summaryStdout);
            var summaryRoot = summaryDocument.RootElement;
            Assert.Equal(2, summaryRoot.GetProperty("total_count").GetInt32());
            Assert.Equal(2, summaryRoot.GetProperty("returned_count").GetInt32());
            Assert.Equal(0, summaryRoot.GetProperty("omitted_count").GetInt32());
            Assert.False(summaryRoot.GetProperty("truncated").GetBoolean());
            var summaries = summaryRoot.GetProperty("drafts").EnumerateArray().ToArray();
            Assert.Equal(2, summaries.Length);
            var rawDiagnosticSummary = Assert.Single(
                summaries,
                item => item.GetProperty("query_name").GetString() == "raw-diagnostic-echo");
            Assert.Equal(7, rawDiagnosticSummary.GetProperty("file_count").GetInt32());
            Assert.Equal(5, rawDiagnosticSummary.GetProperty("evidence_paths_returned_count").GetInt32());
            Assert.Equal(2, rawDiagnosticSummary.GetProperty("evidence_paths_omitted_count").GetInt32());
            Assert.True(rawDiagnosticSummary.GetProperty("evidence_paths_truncated").GetBoolean());
            Assert.Contains(
                "cdidx search --recipe risky-code/raw-diagnostic-echo --format issue-drafts",
                rawDiagnosticSummary.GetProperty("replay_command").GetString(),
                StringComparison.Ordinal);
            ...
            var (truncatedExitCode, truncatedStdout, truncatedStderr) = CaptureConsole(() => QueryCommandRunner.RunSearch(
                SummaryArgs("--max-json-bytes", truncatedBudget.ToString(CultureInfo.InvariantCulture)),
                relaxedJsonOptions));

            Assert.Equal(CommandExitCodes.Success, truncatedExitCode);
            Assert.Equal(string.Empty, truncatedStderr);
            ...
            var (utf8ExitCode, utf8Stdout, utf8Stderr) = CaptureConsole(() => QueryCommandRunner.RunSearch(
                SummaryArgs("--max-json-bytes", utf8Budget.ToString(CultureInfo.InvariantCulture)),
                relaxedJsonOptions));

            Assert.Equal(CommandExitCodes.Success, utf8ExitCode);
            Assert.Equal(string.Empty, utf8Stderr);
            Assert.True(Encoding.UTF8.GetByteCount(utf8Stdout) <= utf8Budget);
            using var utf8Document = ParseJsonOutput(utf8Stdout);
            Assert.True(utf8Document.RootElement.GetProperty("returned_count").GetInt32() < 2);

            var (envelopeExitCode, envelopeStdout, envelopeStderr) = CaptureConsole(() => ProgramRunner.Run(
                ["audit", "risky-code", .. SummaryArgs("--max-json-bytes", "1").Skip(2)],
                relaxedJsonOptions,
                "test"));
            ...
            Assert.Equal("E028_RESPONSE_BUDGET_TOO_SMALL", envelopeRoot.GetProperty("error_code").GetString());
            Assert.Equal("audit", envelopeRoot.GetProperty("command").GetString());
            Assert.StartsWith("cdidx audit ", envelopeRoot.GetProperty("usage").GetString(), StringComparison.Ordinal);
            Assert.Equal(
                "audit",
                envelopeRoot.GetProperty("retry").GetProperty("command").GetString());

            var (fullExitCode, fullStdout, fullStderr) = CaptureConsole(() => QueryCommandRunner.RunSearch(
                [
                    "--recipe", "risky-code/raw-diagnostic-echo",
                    "--db", dbPath,
                    "--format", "issue-drafts",
            ...
            Assert.Equal("full", fullRoot.GetProperty("metadata_mode").GetString());
            Assert.True(fullRoot.TryGetProperty("recipe", out _));
            Assert.False(fullRoot.TryGetProperty("recipe_summary", out _));
            var fullDraft = Assert.Single(fullRoot.GetProperty("drafts").EnumerateArray());
            Assert.True(fullDraft.TryGetProperty("body", out _));
            Assert.True(fullDraft.TryGetProperty("source", out _));
            Assert.True(fullDraft.TryGetProperty("evidence", out _));
        }
        finally
        {
            TestProjectHelper.DeleteDirectory(projectRoot);
    ...
    public void RunExcerpt_JsonMaxBytesRejectsOversizedPayload_Issue4311()
    {
        ...
        try
        {
            ...
            Assert.Equal("excerpt", error.GetProperty("command").GetString());
