...
public partial class ReferenceExtractorTests
{
    ...
    [Fact]
    public void BuiltInReferenceRegexes_UseDefaultBacktrackingPolicy_Issue3479()
    {
        var regexes = EnumerateStaticRegexValues(
            typeof(ReferenceExtractor).Assembly.GetTypes().Where(IsReferenceRegexOwnerType))
            .ToList();
        ...
        Assert.True(
            ...
            "Built-in reference regexes that use backtracking must use BoundedRegex.DefaultMatchTimeout: "
