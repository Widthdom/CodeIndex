...
public class ConsoleUiTests
{
    ...
    public void PrintCommandUsage_InspectSplitsQueryAndLinePathModes_Issue3916()
    {
        ...
        Assert.All(usageLines, line => Assert.Contains("--fields <csv|list>", line, StringComparison.Ordinal));
        Assert.Contains("collection.field leaves", output, StringComparison.Ordinal);
        Assert.Contains("--fields list prints the machine-readable catalog", output, StringComparison.Ordinal);
    }
    ...
    public void PrintUsage_WithoutBanner_HidesAsciiArtAndEasterEggFlags()
    {
        ...
        Assert.Contains("cdidx backfill-fold [--db <path>] [--dry-run] [--checkpoint|--no-checkpoint] [--show-paths] [--json]", output);
        Assert.Contains("cdidx optimize [--db <path>] [--dry-run] [--show-paths] [--json]", output);
        ...
        Assert.Contains("cdidx excerpt <path[:line|:start-end]> [--line <line>|--start <line>|--start-line <line>] [--end <line|eof>|--end-line <line>] [--start-column <column>] [--end-column <column>] [--clamp] [--context <n>|--before <n>|--after <n>] [--max-line-width <n>] [--focus-line <line>] [--focus-column <n>] [--focus-length <n>] [--db <path>] [--json] [--redact-paths|--show-paths] [--no-semantic-tokens] [--max-json-bytes <n>] [--verbose]", output);
        ...
        Assert.Contains("cdidx inspect Run --json --fields definitions.name,definitions.path,references.line", output);
