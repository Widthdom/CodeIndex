...
public partial class QueryCommandRunnerTests
{
    ...
    public void SearchMatchClassifier_ShellSubstitutionQuotesEscapesAndBounds_Issue5275()
    {
        ...
        [
            ...
            ("value=\"$(case x in x|esac) needle;; esac)\"", "code"),
            ("value=\"$(case x in (esac|x) needle;; esac)\"", "code"),
            ("value=\"$(case x in x|esac) echo ok;; esac) needle\"", "string_literal"),
            ("value=\"$(case x in esac) needle\"", "string_literal"),
            ("value=\"$(case x in (x) needle;; esac)\"", "code"),
    ...
    public void RunSearch_ShellSubstitutionsPreserveOriginsFiltersAndCoordinates_Issue5275()
    {
        ...
        try
        {
            ...
            [
                ...
                ("src/case-alternative.sh", "value=\"$(case x in x|esac) run_curl_with_optional_loopback_bypass --help;; esac)\"", "code"),
